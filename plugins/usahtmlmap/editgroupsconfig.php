...
if((isset($_POST['act_type']) && $_POST['act_type'] == 'usa-html5-map-groups-create') && current_user_can('manage_options')) {
...
}elseif((isset($_POST['act_type']) && $_POST['act_type'] == 'usa-html5-map-groups-save') && current_user_can('manage_options')) {
...
echo "<div class=\"wrap\"><h2>" . __('Configuration of groups', 'usa-html5-map') . "</h2>";
...
<br />
<form method="POST" class="usa-html5-map main" name="action_form">
<?php 
...
uasort($states, 'usa_html5map_plugin_sort_states_by_name');
